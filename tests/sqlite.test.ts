...
function testFunction() {
	return createChecker(db, "sqlite");
}
	...
	describe("users table", () => {
		describe("id field", () => {
			it("should throw an error when users table does not exist in database", async () => {
				await expect(testFunction().checkTableWithSchema("slip_users", usersSchema)).rejects.toThrowError(
	...
	describe("sessions table", () => {
		...
		describe("id field", () => {
			it("should throw an error when sessions table does not exist in database", async () => {
				await expect(testFunction().checkTableWithSchema("slip_sessions", sessionsSchema)).rejects.toThrowError(
	...
	describe("slip_oauth_accounts table", () => {
		...
		describe("provider_id field", () => {
			it("should throw an error when oauth table does not exist in database", async () => {
				await expect(testFunction().checkTableWithSchema("slip_oauth_accounts", oauthAccountsSchema)).rejects.toThrowError(
